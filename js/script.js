...
function useWeatherData(data){
    ...
    var weather = `<div class="day d-flex justify-between align-center" id="today">
                    ...
                    <div class="day d-flex justify-between align-center" id="tomorrow">
                        <h3>Tomorrow</h3>
                        <img src="https:${data.forecast.forecastday[1].day.condition.icon}" alt="${data.forecast.forecastday[1].day.condition.text}" id="img-tomorrow">
                        <p id="description-tomorrow">${data.forecast.forecastday[1].day.condition.text}</p>
                        <div class="d-flex justify-between">
                    ...
                    <div class="day d-flex justify-between align-center" id="friday">
                        <h3>Friday</h3>
                        <img src="https:${data.forecast.forecastday[2].day.condition.icon}" alt="${data.forecast.forecastday[2].day.condition.icon}" id="img-friday">
                        <p id="description-friday">${data.forecast.forecastday[2].day.condition.text}</p>
                        <div class="d-flex justify-between">
                    ...
                    <div class="day d-flex justify-between align-center" id="saturday">
                        <h3>Saturday</h3>
                        <img src="https:${data.forecast.forecastday[3].day.condition.icon}" alt="${data.forecast.forecastday[3].day.condition.text}" id="img-saturday">
                        <p id="description-saturday">${data.forecast.forecastday[3].day.condition.text}</p>
                        <div class="d-flex justify-between">
                            <p class="high"><span class="nr">${data.forecast.forecastday[3].day.maxtemp_c}</span>&#176;</p>
                            <p class="low"><span class="nr">${data.forecast.forecastday[3].day.mintemp_c}</span>&#176;</p>
                        </div>
                    </div>`
